...
namespace RookieShop.Backend.Migrations
{
    ...
    [Migration("20210722045901_AddSoftDeleteAttr")]
            ...
            modelBuilder.Entity("RookieShop.Backend.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            id = "RSCAPM0001",
                            amount = 100,
                            createDate = new DateTime(2021, 7, 22, 11, 59, 0, 327, DateTimeKind.Local).AddTicks(3727),
                            description = "Limited edition printed shirt at New York Athletic club event 2020",
                            imageUri = "ProductImage/m1.jpg",
                            isDeleted = false,
                            modifyDate = new DateTime(2021, 7, 22, 11, 59, 0, 328, DateTimeKind.Local).AddTicks(7372),
                        ...
                        new
                        {
                            id = "RSCAPM0002",
                            amount = 200,
                            createDate = new DateTime(2021, 7, 22, 11, 59, 0, 328, DateTimeKind.Local).AddTicks(7921),
                            description = "Favorite biker jacket variant made by natural Croc skin",
                            imageUri = "ProductImage/m2.jpg",
                            isDeleted = false,
                            modifyDate = new DateTime(2021, 7, 22, 11, 59, 0, 328, DateTimeKind.Local).AddTicks(7927),
                        ...
                        new
                        {
                            id = "RSCAPM0003",
                            amount = 120,
                            createDate = new DateTime(2021, 7, 22, 11, 59, 0, 328, DateTimeKind.Local).AddTicks(7930),
                            description = "Fan thanks t-shirt at Tom&Jerry anniversary show",
                            imageUri = "ProductImage/m3.jpg",
                            isDeleted = false,
                            modifyDate = new DateTime(2021, 7, 22, 11, 59, 0, 328, DateTimeKind.Local).AddTicks(7932),
                        ...
                        new
                        {
                            id = "RSCAPWM0001",
                            amount = 80,
                            createDate = new DateTime(2021, 7, 22, 11, 59, 0, 328, DateTimeKind.Local).AddTicks(7935),
                            description = "Top 300 Fashion dress in 2020",
                            imageUri = "ProductImage/wm1.jpg",
                            isDeleted = false,
                            modifyDate = new DateTime(2021, 7, 22, 11, 59, 0, 328, DateTimeKind.Local).AddTicks(7936),
                        ...
                        new
                        {
                            id = "RSCAPWM0002",
                            amount = 150,
                            createDate = new DateTime(2021, 7, 22, 11, 59, 0, 328, DateTimeKind.Local).AddTicks(7938),
                            description = "Suitable for jogging and casual",
                            imageUri = "ProductImage/wm2.jpg",
                            isDeleted = false,
                            modifyDate = new DateTime(2021, 7, 22, 11, 59, 0, 328, DateTimeKind.Local).AddTicks(7940),
                            name = "Karo dress",
                            price = 900000f
                        },
                        new
                        {
                            id = "RSCAPWM0003",
                            amount = 50,
                            createDate = new DateTime(2021, 7, 22, 11, 59, 0, 328, DateTimeKind.Local).AddTicks(7949),
                            description = "Best seller product in 2020",
                            imageUri = "ProductImage/wm3.jpg",
                            isDeleted = false,
                            modifyDate = new DateTime(2021, 7, 22, 11, 59, 0, 328, DateTimeKind.Local).AddTicks(7951),
                        ...
                        new
                        {
                            id = "RSCAPBB0001",
                            amount = 90,
                            createDate = new DateTime(2021, 7, 22, 11, 59, 0, 328, DateTimeKind.Local).AddTicks(7954),
                            description = "Best seller baby product in June 2020",
                            imageUri = "ProductImage/bb1.jpg",
                            isDeleted = false,
                            modifyDate = new DateTime(2021, 7, 22, 11, 59, 0, 328, DateTimeKind.Local).AddTicks(7955),
                        ...
                        new
                        {
                            id = "RSCAPBB0002",
                            amount = 100,
                            createDate = new DateTime(2021, 7, 22, 11, 59, 0, 328, DateTimeKind.Local).AddTicks(7957),
                            description = "Best seller baby product in Jan 2020",
                            imageUri = "ProductImage/bb2.jpg",
                            isDeleted = false,
                            modifyDate = new DateTime(2021, 7, 22, 11, 59, 0, 328, DateTimeKind.Local).AddTicks(7959),
                        ...
                        new
                        {
                            id = "RSCAPBB0003",
                            amount = 100,
                            createDate = new DateTime(2021, 7, 22, 11, 59, 0, 328, DateTimeKind.Local).AddTicks(7962),
                            description = "Best seller baby product in Apr 2020",
                            imageUri = "ProductImage/bb3.jpg",
                            isDeleted = false,
                            modifyDate = new DateTime(2021, 7, 22, 11, 59, 0, 328, DateTimeKind.Local).AddTicks(7963),
